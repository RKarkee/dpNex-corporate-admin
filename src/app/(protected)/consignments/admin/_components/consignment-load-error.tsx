 ...
 * the consignment is gone, or the id was never valid — and "not found" with a
 * way back to the list is the whole answer.
 *
 ...
 */
export function ConsignmentLoadError({
  error,
  onRetry,
}: {
  error: unknown;
  ...
  return (
    <Card className="flex flex-col items-center justify-center px-6 py-16 text-center">
      ...
      <h3 className="mt-4 text-base font-semibold text-foreground">
        Could not load this consignment
      </h3>
      {/* `ApiError.message` is already sanitised; a raw upstream body would leak
          stack traces at 5xx. */}
