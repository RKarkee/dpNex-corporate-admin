 ...
 * navigating — middle-click and "open in new tab" work, the back button steps
 * between tabs, and there is no active-tab state to keep in sync with the URL.
 *
...
export function DetailTabs({ id }: { id: number }) {
  ...
  return (
    <div
      ...
      role="navigation"
      aria-label="Consignment sections"
