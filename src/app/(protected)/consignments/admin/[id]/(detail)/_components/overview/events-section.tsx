...
/**
 * The consignment's activity log — every event the API recorded (views, status
 ...
 * consignment collects dozens of VIEWED rows, which would otherwise push the rest
