...
import { useReassignConsignment } from "../../../../_hooks/use-consignment-actions";
 ...
 * someone holds the consignment. Handing it to the person who already has it is
        ...
        <DialogHeader>
          ...
          <DialogDescription>
            {currentAssignee ? (
              ...
              "Move this consignment to another user."
            )}
          </DialogDescription>
        </DialogHeader>
...
function ReassignForm({
  ...
  const reassign = useReassignConsignment(consignmentId);
