 ...
 *
 * Two nested `useFieldArray`s — one for boxes, one per box for its items.
 * The meta options are fetched once at the top and threaded down as props
 * rather than re-hooked per row: a ten-box request would otherwise mount
    ...
    <div className="space-y-3 border-t border-border bg-secondary/30 px-4 pb-4 pt-3">
      <div className="flex items-center justify-between gap-2">
        ...
        <Button
          ...
          variant="ghost"
          size="sm"
          onClick={() => append({ ...newBoxItemDefaults })}
        >
